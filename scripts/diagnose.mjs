...
async function diagnose() {
  ...
  // 2. Check pending_offpremises_checkins table
  ...
  // 3. Check requests from last 2 days
  ...
  // 4. Also check attendance_records for off-premises
  ...
  // 5. Check all statuses in pending_offpremises_checkins
