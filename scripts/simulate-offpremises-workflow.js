...
async function simulateOffPremisesWorkflow() {
  ...
  try {
    ...
    if (!tableError) {
      ...
      console.log('   (Table empty or checking structure)')
    }
    console.log()
    ...
    if (checkInError) {
      console.error('❌ Failed to create check-in request:', checkInError.message)
      return
    }
    ...
    if (approveError) {
      console.error('❌ Failed to approve check-in:', approveError.message)
      return
    }
    ...
    if (attendanceError) {
      console.error('❌ Failed to create attendance record:', attendanceError.message)
      return
    }
    ...
    if (checkOutReqError) {
      console.error('❌ Failed to create check-out request:', checkOutReqError.message)
      return
    }
    ...
    if (checkoutUpdateError) {
      console.error('❌ Failed to update attendance record for checkout:', checkoutUpdateError.message)
      return
    }
    ...
    if (checkoutStatusError) {
      console.error('❌ Failed to approve check-out request:', checkoutStatusError.message)
      return
    }
    ...
    if (fetchError) {
      console.error('❌ Failed to fetch all requests:', fetchError.message)
      return
    }
    ...
    if (fetchAttendanceError) {
      console.error('❌ Failed to fetch attendance record:', fetchAttendanceError.message)
      return
    }
